    ...
    <div class="sidebar" data-color="dark" data-active-color="danger">
        <div class="logo">
            <a href="#" class="simple-text">
                <span class="mx-5"> <img src="{{asset('icons/logo-round.png')}}" alt="Profile"
                                         class="img1 rounded"></span>
            ...
            <ul class="nav">
                <li style="list-style-type: circle!important;">
                    <div class="form-inline mx-4">
                        ...
                        <span class="mx-2"></span><a href="/applicant-dashboard"
                ...
                <li style="list-style-type: circle!important;">
                    <div class="form-inline mx-4">
                        <span></span><img src="{{asset('icons/dot.PNG')}}" alt=""
                                          style="border-radius: 100px!important; width: 20px!important; height: 20px!important;">
                        <span class="mx-2"></span><a href="/applicant-announcement-page"
                                                     style="color: white!important; text-decoration: none!important;">Announcements</a>
                    </div>
               ...
               <hr>
                <li style="list-style-type: circle!important;">
                    <div class="form-inline mx-4">
                        <span></span><img src="{{asset('icons/dot.PNG')}}" alt=""
                                          style="border-radius: 100px!important; width: 20px!important; height: 20px!important;">
                        <span class="mx-2"></span><a href="/my-application"
                                                     style="color: white!important; text-decoration: none!important;">My Applications</a>
                    </div>
...
<li style="list-style-type: circle!important;">
    <div class="form-inline mx-4">
        <span></span><img src="{{asset('icons/dot.PNG')}}" alt=""
                          style="border-radius: 100px!important; width: 20px!important; height: 20px!important;">
        <span class="mx-2"></span><a href="/my-account"
                                     style="color: white!important; text-decoration: none!important;">My Account</a>
    </div>
...
<hr>
    ...
    <div class="main-panel">
        <!-- Navbar -->
        <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent shadow-lg h">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <div class="mx-5 h5">Online Financial Aid Application System (Koforidua TechnicalUniversity)</div>
                </div>
                <ul>
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle  text-success" href="#" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            {{ $applicant->student_name }} <span class="mx-1"> ( {{ $applicant->index_number}})</span>
                        </a>
