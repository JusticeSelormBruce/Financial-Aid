...
@section('render')
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row">
            <div class="mx-auto">  @if($data == null)
                                ...
                                <div class="design input-group-sm py-2">
                                    ...
                                    <div class="row py-2">
                                        @foreach($privileges as $list)
                                            <div class="col-4 input-group-sm  no-gutters">
                        ...
                        <div class="row">
                            <div class="mx-auto w-50">
                                <div class="design input-group-sm py-2">
                                    ...
                                    <div class="row py-2">
                                        @foreach($privileges as $list)
                                            <div class="col-4 input-group-sm no-gutters mx-5 ">
                                                <input type="checkbox" name="role_id[]" value="{{$list->id}}"
                                                       class="mr-2 py-2" @foreach($userRoles as $roles) @if($list->id ==$roles) checked @endif @endforeach> <span>{{$list->name}}</span>
                                            </div>
                                        @endforeach
