...
<button type="button" class="btn text-primary   " data-toggle="modal"
    ...
    <span class=" text-capitalize ">Load Funds</span>
</button>
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mt-5" style="font-size: small!important;">
                <form action="/admin/load-funds" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="mx-auto">
                        <button class="btn btn-primary" type="submit"><span class="mx-5">Load Funds</span></button>
                    </div>
                </div>
                </form>
            </div>
